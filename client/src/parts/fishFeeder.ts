...
export class FishFeederPart extends MockFishFeederPart implements IMouseHandler, IUiPart {

    sprite: Sprite;
    override ["deploy-bait"](): void {
        if (!UI.useMouseHandler(this)) return;
        UI.setHintText("click to place bait");
        this.sprite = Sprite.from("/assets/bait.png");
